...
class FavDayAdater (private var items: ArrayList<Hourly>) : RecyclerView.Adapter<FavDayAdater.DayViewHolder>() {
    ...
    private fun iconLinkgetter(iconName:String):String= "https://openweathermap.org/img/wn/$iconName@2x.png"
