...
class FavDayAdater (var items: ArrayList<Hourly>) : RecyclerView.Adapter<FavDayAdater.DayViewHolder>() {
    ...
    override fun onBindViewHolder(holder: DayViewHolder, position: Int) {
        ...
        Glide.with(holder.img.context).load(iconLinkgetter(items[position].weather.get(0).icon))
